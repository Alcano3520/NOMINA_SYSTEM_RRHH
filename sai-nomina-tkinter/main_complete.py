...
class SAICompleteApp:
    ...
    def show_decimos_module(self):
        ...
        module = DecimosCompleteModule(self.content_area, self)
    ...
    def show_vacaciones_module(self):
        ...
        module = VacacionesCompleteModule(self.content_area, self)
    ...
    def show_liquidaciones_module(self):
        ...
        module = LiquidacionesCompleteModule(self.content_area, self)
    ...
    def show_prestamos_module(self):
        ...
        module = PrestamosCompleteModule(self.content_area, self)
    ...
    def show_dotacion_module(self):
        ...
        module = DotacionCompleteModule(self.content_area, self)
    ...
    def show_reportes_module(self):
        ...
        module = ReportesCompleteModule(self.content_area, self)
    ...
    def show_departamentos_module(self):
        ...
        module = DepartamentosCompleteModule(self.content_area, self)
    ...
    def show_turnos_module(self):
        ...
        module = TurnosCompleteModule(self.content_area, self)
    ...
    def show_equipos_module(self):
        ...
        module = EquiposCompleteModule(self.content_area, self)
    ...
    def show_clientes_module(self):
        ...
        module = ClientesCompleteModule(self.content_area, self)
    ...
    def show_rpemplea_module(self):
        ...
        module = RPEmpleaCompleteModule(self.content_area, self)
    ...
    def show_rphistor_module(self):
        ...
        module = RPHistorCompleteModule(self.content_area, self)
    ...
    def show_rpcontrl_module(self):
        ...
        module = RPContrlCompleteModule(self.content_area, self)
